...
public class EsbSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EsbPackage.CACHE_HTTP_METHODS: {
				CacheHttpMethods cacheHttpMethods = (CacheHttpMethods)theEObject;
				T result = caseCacheHttpMethods(cacheHttpMethods);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	public T caseCommentMediator(CommentMediator object) {
		return null;
				...
				/**
	 * Returns the result of interpreting the object as an instance of '<em>Cache Http Methods</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Cache Http Methods</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCacheHttpMethods(CacheHttpMethods object) {
		return null;
	}
