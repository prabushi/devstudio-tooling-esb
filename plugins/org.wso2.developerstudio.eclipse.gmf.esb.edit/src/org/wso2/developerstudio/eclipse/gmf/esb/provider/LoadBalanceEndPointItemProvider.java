...
public class LoadBalanceEndPointItemProvider extends ParentEndPointItemProvider {
    ...
    protected void addSessionTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_LoadBalanceEndPoint_sessionType_feature",
                        "_UI_LoadBalanceEndPoint_type"),
                EsbPackage.Literals.LOAD_BALANCE_END_POINT__SESSION_TYPE, true, false, false,
    ...
    protected void addAlgorithmPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_LoadBalanceEndPoint_algorithm_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_LoadBalanceEndPoint_algorithm_feature",
                                "_UI_LoadBalanceEndPoint_type"),
                        EsbPackage.Literals.LOAD_BALANCE_END_POINT__ALGORITHM, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Basic", null));
    }
    ...
    protected void addSessionTimeoutPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_LoadBalanceEndPoint_sessionTimeout_feature",
                        "_UI_LoadBalanceEndPoint_type"),
                EsbPackage.Literals.LOAD_BALANCE_END_POINT__SESSION_TIMEOUT, true, false, false,
                ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, "Basic", null));
    }
    ...
    protected void addBuildMessagePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_LoadBalanceEndPoint_buildMessage_feature",
                        "_UI_LoadBalanceEndPoint_type"),
                EsbPackage.Literals.LOAD_BALANCE_END_POINT__BUILD_MESSAGE, true, false, false,
